...
namespace SHSApp_Char
{
    ...
    class WordDocument
    {
        ...
        public void InsertPictureIntoTable(string pathToFile, int row, int column)
        {
            _table.Cell(row, column).Range.InlineShapes.AddPicture(pathToFile, false, true);
            _table.Cell(row, column).Range.InlineShapes[1].Height = 170.1F;
            _table.Cell(row, column).Range.InlineShapes[1].Width = 127.575F;
        }
